...
@section('template')
    ...
    <div class="row">
        <div class="col s12">
            ...
            <h4>
                Articles
                <a href="{{route('article.create')}}" class="waves-effect waves-light btn right"><i class="material-icons left">add</i>New</a>
            </h4>
                    ...
                    <li>
                        <div class="collapsible-header truncate">
                            ...
                            <div class="actions right">
                                ...
                                <a class="blue-text text-lighten-2 view" href="{{ route('article.show', $article->id) }}" target="_blank" title="View article">
                                    <i class="material-icons">open_in_new</i>
                                </a>

                                <a class="teal-text text-darken-1 edit"  href="{{ route('article.edit', $article->id) }}" title="Edit article">
