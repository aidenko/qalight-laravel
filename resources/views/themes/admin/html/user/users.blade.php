...
@section('template')
    ...
    <div class="row">
        <div class="col s12">
            ...
            <h4>
                Users
                <a href="{{route('users.create')}}" class="waves-effect waves-light btn right"><i class="material-icons left">add</i>New</a>
            </h4>
                ...
                @foreach($users as $user)
                    <li>
                        <div class="collapsible-header truncate">
                            ...
                            <a class="teal-text text-darken-1 right edit"  href="{{ route('users.edit', $user->id) }}" title="Edit user">
                                <i class="material-icons">edit</i>
                            </a>

                            <a class="blue-text text-lighten-2 right view" href="{{ route('users.show', $user->id) }}" target="_blank" title="View user">
